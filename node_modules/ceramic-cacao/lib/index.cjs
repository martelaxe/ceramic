var apgApi = require('apg-js/src/apg-api/api.js');
var apgLib = require('apg-js/src/apg-lib/node-exports.js');
var caip = require('caip');
...
var apgApi__default = /*#__PURE__*/_interopDefaultLegacy(apgApi);
var apgLib__default = /*#__PURE__*/_interopDefaultLegacy(apgLib);
...
class ParsedMessage {
  constructor(msg) {
    ...
    const api = new apgApi__default["default"](GRAMMAR);
    api.generate();
    ...
    const parser = new apgLib__default["default"].parser();
    parser.ast = new apgLib__default["default"].ast();
    const id = apgLib__default["default"].ids;

    const domain = function (state, chars, phraseIndex, phraseLength, data) {
      const ret = id.SEM_OK;

      if (state === id.SEM_PRE) {
        data.domain = apgLib__default["default"].utils.charsToString(chars, phraseIndex, phraseLength);
      }
    ...
    const address = function (state, chars, phraseIndex, phraseLength, data) {
      ...
      if (state === id.SEM_PRE) {
        data.address = apgLib__default["default"].utils.charsToString(chars, phraseIndex, phraseLength);
      }
    ...
    const statement = function (state, chars, phraseIndex, phraseLength, data) {
      ...
      if (state === id.SEM_PRE) {
        data.statement = apgLib__default["default"].utils.charsToString(chars, phraseIndex, phraseLength);
      }
    ...
    const uri = function (state, chars, phraseIndex, phraseLength, data) {
      ...
      if (state === id.SEM_PRE) {
        if (!data.uri) {
          data.uri = apgLib__default["default"].utils.charsToString(chars, phraseIndex, phraseLength);
        }
      }
    ...
    const version = function (state, chars, phraseIndex, phraseLength, data) {
      ...
      if (state === id.SEM_PRE) {
        data.version = apgLib__default["default"].utils.charsToString(chars, phraseIndex, phraseLength);
      }
    ...
    const chainId = function (state, chars, phraseIndex, phraseLength, data) {
      ...
      if (state === id.SEM_PRE) {
        data.chainId = apgLib__default["default"].utils.charsToString(chars, phraseIndex, phraseLength);
      }
    ...
    const nonce = function (state, chars, phraseIndex, phraseLength, data) {
      ...
      if (state === id.SEM_PRE) {
        data.nonce = apgLib__default["default"].utils.charsToString(chars, phraseIndex, phraseLength);
      }
    ...
    const issuedAt = function (state, chars, phraseIndex, phraseLength, data) {
      ...
      if (state === id.SEM_PRE) {
        data.issuedAt = apgLib__default["default"].utils.charsToString(chars, phraseIndex, phraseLength);
      }
    ...
    const expirationTime = function (state, chars, phraseIndex, phraseLength, data) {
      ...
      if (state === id.SEM_PRE) {
        data.expirationTime = apgLib__default["default"].utils.charsToString(chars, phraseIndex, phraseLength);
      }
    ...
    const notBefore = function (state, chars, phraseIndex, phraseLength, data) {
      ...
      if (state === id.SEM_PRE) {
        data.notBefore = apgLib__default["default"].utils.charsToString(chars, phraseIndex, phraseLength);
      }
    ...
    const requestId = function (state, chars, phraseIndex, phraseLength, data) {
      ...
      if (state === id.SEM_PRE) {
        data.requestId = apgLib__default["default"].utils.charsToString(chars, phraseIndex, phraseLength);
      }
    ...
    const resources = function (state, chars, phraseIndex, phraseLength, data) {
      ...
      if (state === id.SEM_PRE) {
        data.resources = apgLib__default["default"].utils.charsToString(chars, phraseIndex, phraseLength).slice(3).split('\n- ');
      }
...
class SiweMessage {
  ...
  static fromCacao(cacao) {
    const account = caip.AccountId.parse(cacao.p.iss.replace('did:pkh:', ''));
    const siwe = new SiweMessage({
      domain: cacao.p.domain,
      address: account.address,
      uri: cacao.p.aud,
      version: cacao.p.version,
      chainId: new caip.ChainId(account.chainId).reference
    });
    ...
    if (cacao.s) {
      ...
      if (cacao.s.t === 'eip191') siwe.type = exports.SignatureType.PERSONAL_SIGNATURE;
    }
  ...
  signMessage() {
    ...
    switch (this.type) {
      case exports.SignatureType.PERSONAL_SIGNATURE:
        {
...
(function (Cacao) {
  ...
  function verifyEIP191Signature(cacao, options) {
    ...
    const sig = cacao.s.s;
    const recoveredAddress = wallet.verifyMessage(msg.toMessage(), sig);
    const issAddress = caip.AccountId.parse(cacao.p.iss.replace('did:pkh:', '')).address;
...
})(exports.Cacao || (exports.Cacao = {}));

exports.CacaoBlock = void 0;

(function (CacaoBlock) {
  const fromCacao = function (cacao) {
    try {
      return Promise.resolve(Block__namespace.encode({
        value: cacao,
...
})(exports.CacaoBlock || (exports.CacaoBlock = {}));
