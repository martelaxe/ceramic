...
* @returns {ExtendedKey}
*/
module.exports.keyDerive = function(mnemonic, path, password, language_code) {
...
* @returns {ExtendedKey}
*/
module.exports.keyDeriveFromSeed = function(seed, path) {
...
* @returns {ExtendedKey}
*/
module.exports.keyRecover = function(private_key_js, testnet) {
...
* @returns {ExtendedKey}
*/
module.exports.keyRecoverBLS = function(private_key_js, testnet) {
...
* @returns {string}
*/
module.exports.transactionSerialize = function(message) {
    try {
        const retptr = wasm.__wbindgen_export_2.value - 16;
        wasm.__wbindgen_export_2.value = retptr;
...
* @returns {Uint8Array}
*/
module.exports.transactionSerializeRaw = function(unsigned_message) {
    try {
        const retptr = wasm.__wbindgen_export_2.value - 16;
        wasm.__wbindgen_export_2.value = retptr;
...
* @returns {any}
*/
module.exports.transactionParse = function(cbor_js, testnet) {
...
* @returns {any}
*/
module.exports.transactionSign = function(unsigned_tx_js, private_key_js) {
...
* @returns {string}
*/
module.exports.transactionSignLotus = function(unsigned_tx_js, private_key_js) {
    try {
        const retptr = wasm.__wbindgen_export_2.value - 16;
        wasm.__wbindgen_export_2.value = retptr;
...
* @returns {any}
*/
module.exports.transactionSignRaw = function(unsigned_tx_js, private_key_js) {
...
* @returns {boolean}
*/
module.exports.verifySignature = function(signature_js, message_js) {
...
* @returns {any}
*/
module.exports.createMultisigWithFee = function(sender_address, addresses, value, required, nonce, duration, start_epoch, gas_limit, gas_fee_cap, gas_premium) {
...
* @returns {any}
*/
module.exports.createMultisig = function(sender_address, addresses, value, required, nonce, duration, start_epoch) {
    var ptr0 = passStringToWasm0(sender_address, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    var len0 = WASM_VECTOR_LEN;
    var ptr1 = passArrayJsValueToWasm0(addresses, wasm.__wbindgen_malloc);
    var len1 = WASM_VECTOR_LEN;
...
* @returns {any}
*/
module.exports.proposeMultisigWithFee = function(multisig_address, to_address, from_address, amount, nonce, gas_limit, gas_fee_cap, gas_premium) {
...
* @returns {any}
*/
module.exports.proposeMultisig = function(multisig_address, to_address, from_address, amount, nonce) {
    var ptr0 = passStringToWasm0(multisig_address, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    var len0 = WASM_VECTOR_LEN;
    var ptr1 = passStringToWasm0(to_address, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    var len1 = WASM_VECTOR_LEN;
...
* @returns {any}
*/
module.exports.approveMultisigWithFee = function(multisig_address, message_id, proposer_address, to_address, amount, from_address, nonce, gas_limit, gas_fee_cap, gas_premium) {
    var ptr0 = passStringToWasm0(multisig_address, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    var len0 = WASM_VECTOR_LEN;
...
* @returns {any}
*/
module.exports.approveMultisig = function(multisig_address, message_id, proposer_address, to_address, amount, from_address, nonce) {
    var ptr0 = passStringToWasm0(multisig_address, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    var len0 = WASM_VECTOR_LEN;
    var ptr1 = passStringToWasm0(proposer_address, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    var len1 = WASM_VECTOR_LEN;
...
* @returns {any}
*/
module.exports.cancelMultisigWithFee = function(multisig_address, message_id, proposer_address, to_address, amount, from_address, nonce, gas_limit, gas_fee_cap, gas_premium) {
    var ptr0 = passStringToWasm0(multisig_address, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    var len0 = WASM_VECTOR_LEN;
    var ptr1 = passStringToWasm0(proposer_address, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    var len1 = WASM_VECTOR_LEN;
...
* @returns {any}
*/
module.exports.cancelMultisig = function(multisig_address, message_id, proposer_address, to_address, amount, from_address, nonce) {
    var ptr0 = passStringToWasm0(multisig_address, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    var len0 = WASM_VECTOR_LEN;
    var ptr1 = passStringToWasm0(proposer_address, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    var len1 = WASM_VECTOR_LEN;
...
* @returns {any}
*/
module.exports.createPymtChanWithFee = function(from_address, to_address, amount, nonce, gas_limit, gas_fee_cap, gas_premium) {
...
* @returns {any}
*/
module.exports.createPymtChan = function(from_address, to_address, amount, nonce) {
    var ptr0 = passStringToWasm0(from_address, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    var len0 = WASM_VECTOR_LEN;
    var ptr1 = passStringToWasm0(to_address, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    var len1 = WASM_VECTOR_LEN;
...
* @returns {any}
*/
module.exports.settlePymtChanWithFee = function(pch_address, from_address, nonce, gas_limit, gas_fee_cap, gas_premium) {
...
* @returns {any}
*/
module.exports.settlePymtChan = function(pch_address, from_address, nonce) {
    var ptr0 = passStringToWasm0(pch_address, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    var len0 = WASM_VECTOR_LEN;
    var ptr1 = passStringToWasm0(from_address, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    var len1 = WASM_VECTOR_LEN;
...
* @returns {any}
*/
module.exports.collectPymtChanWithFee = function(pch_address, from_address, nonce, gas_limit, gas_fee_cap, gas_premium) {
    var ptr0 = passStringToWasm0(pch_address, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    var len0 = WASM_VECTOR_LEN;
    var ptr1 = passStringToWasm0(from_address, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    var len1 = WASM_VECTOR_LEN;
...
* @returns {any}
*/
module.exports.collectPymtChan = function(pch_address, from_address, nonce) {
    var ptr0 = passStringToWasm0(pch_address, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    var len0 = WASM_VECTOR_LEN;
    var ptr1 = passStringToWasm0(from_address, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    var len1 = WASM_VECTOR_LEN;
...
* @returns {any}
*/
module.exports.updatePymtChanWithFee = function(pch_address, from_address, signed_voucher, nonce, gas_limit, gas_fee_cap, gas_premium) {
    var ptr0 = passStringToWasm0(pch_address, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    var len0 = WASM_VECTOR_LEN;
    var ptr1 = passStringToWasm0(from_address, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    var len1 = WASM_VECTOR_LEN;
...
* @returns {any}
*/
module.exports.updatePymtChan = function(pch_address, from_address, signed_voucher, nonce) {
    var ptr0 = passStringToWasm0(pch_address, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    var len0 = WASM_VECTOR_LEN;
    var ptr1 = passStringToWasm0(from_address, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    var len1 = WASM_VECTOR_LEN;
...
* @returns {any}
*/
module.exports.signVoucher = function(voucher, private_key_js) {
...
* @returns {any}
*/
module.exports.createVoucher = function(payment_channel_address, time_lock_min, time_lock_max, amount, lane, nonce, min_settle_height) {
...
* @returns {Uint8Array}
*/
module.exports.serializeParams = function(params_value) {
    try {
        const retptr = wasm.__wbindgen_export_2.value - 16;
        wasm.__wbindgen_export_2.value = retptr;
...
* @returns {any}
*/
module.exports.deserializeParams = function(params_base64, actor_type, method) {
...
* @returns {any}
*/
module.exports.deserializeConstructorParams = function(params_base64, code_cid) {
    var ptr0 = passStringToWasm0(params_base64, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    var len0 = WASM_VECTOR_LEN;
...
* @returns {boolean}
*/
module.exports.verifyVoucherSignature = function(voucher_base64, address_signer) {
...
* @returns {string}
*/
module.exports.getCid = function(message) {
    try {
        const retptr = wasm.__wbindgen_export_2.value - 16;
        wasm.__wbindgen_export_2.value = retptr;
...
module.exports.ExtendedKey = ExtendedKey;
...
module.exports.__wbg_newwithlength_3c570aeea9a95954 = function(arg0) {
    var ret = new Uint8Array(arg0 >>> 0);
    return addHeapObject(ret);
};

module.exports.__wbg_subarray_4eaeb3de00cf1955 = function(arg0, arg1, arg2) {
...
const path = require('path').join(__dirname, 'filecoin_signer_wasm_bg.wasm');
